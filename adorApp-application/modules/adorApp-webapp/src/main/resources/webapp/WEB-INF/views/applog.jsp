...
<body class="body">
  ...
  <div class="container">
    ...
    <a id="social-button" class="btn btn-primary" href="/adorationSecure/socials">Azonosítások</a>
    <a id="audit-button" class="btn btn-primary" href="/adorationSecure/audits">Audit Log</a>
    <a id="translator-button" class="btn btn-primary" href="/adorationSecure/translators">Nyelvek</a>
    </div>
    </fieldset>
