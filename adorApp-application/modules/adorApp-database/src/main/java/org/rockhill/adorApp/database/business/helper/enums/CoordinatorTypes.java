...
public enum CoordinatorTypes {
    ...
    public static CoordinatorTypes getTypeFromId(Integer coordinatorType) {
        ...
        if (HOURLY_COORDINATOR_1.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_2.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_3.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_4.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_5.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_6.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_7.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_8.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_9.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_10.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_11.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_12.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_13.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_14.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_15.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_16.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_17.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_18.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_19.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_20.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_21.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_22.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
        if (HOURLY_COORDINATOR_23.coordinatorValue.equals(coordinatorType)) return HOURLY_COORDINATOR_0;
