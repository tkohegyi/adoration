...
import static org.rockhill.adoration.database.business.BusinessWithLink.HOUR_IN_A_DAY;
...
public class BusinessWithCoordinator extends BusinessBase {
    ...
    public Coordinator getDailyCooOfHour(@NotNull Integer hour) {
        if (hour >= HOUR_IN_A_DAY) {
            return null;
        }
        int dayPart = hour / QUARTER_DAY_IN_HOURS;
        return getByCoordinatorType(HOUR_IN_A_DAY + dayPart * HOUR_IN_A_DAY);
    }
